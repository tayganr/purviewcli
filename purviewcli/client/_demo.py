...
class Demo():
    def demoGenerate(self, args):
        ...
        # principalId = settings.OBJECT_ID
        # print(f'Assigning role [User Access Administrator] to principalId [{principalId}]')
        ...
        cmd = "pv glossary read --glossaryGuid b5544147-c1c5-401c-b835-d3e93e7eaae2 --purviewName purview-sandbox"
        data = runCommand(cmd)
        print('x')
        # print(settings.OBJECT_ID)
        response = ' '
        return response
